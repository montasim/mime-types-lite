// mimeTypesLite.cjs.test.ts
import { MimeType } from '../src';

/**
 * @fileoverview Unit tests for the mimeTypesLite CJS module.
 * These tests ensure that all MIME types are correctly defined, immutable, and return expected values
 * when imported using CommonJS require syntax.
 *
 * @module tests/mimeTypesLite.cjs.test
 * @version 1.0.0
...
const mimeTypesLite = require('../src/index.cjs');

describe('mimeTypesLite (CJS)', () => {
    /**
